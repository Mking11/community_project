...
class GetCourseDatabaseSearch(private val courseListRepository: CourseListRepository) {
    operator fun invoke(search: String): PagingSource<Int, CourseDetailsDbo> {
        return courseListRepository.getCourseBySearch(search)
    }
}