...
class GetItemsRemote<dbo: Dbo, dto: Dto, PrimaryType, T : RepositoryCommon<dbo, dto, PrimaryType>>(
    private val repository: T
) {
//    operator fun invoke(callback: RepoCallback<dto>) {
//        repository.getItemRemote(callback)
//    }
}